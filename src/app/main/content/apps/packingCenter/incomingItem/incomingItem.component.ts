...
import { Product } from './incomingItem.model';
...
@Component({
    ...
    templateUrl  : './incomingItem.component.html',
    styleUrls    : ['./incomingItem.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class IncomingItemComponent implements OnInit, OnDestroy
{
    product = new Product();
    ...
    constructor(
        private productService: IncomingItemService,
    ...
    addProduct()
    {
        ...
        this.productService.addProduct(data)
            .then(() => {
                ...
                this.location.go('apps/packingCenter/incomingItem/' + this.product.id );
            });
    }
