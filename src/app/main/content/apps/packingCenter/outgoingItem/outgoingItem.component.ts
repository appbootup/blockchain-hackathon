...
import { Product } from './outgoingItem.model';
...
@Component({
    ...
    templateUrl  : './outgoingItem.component.html',
    styleUrls    : ['./outgoingItem.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class OutgoingItemComponent implements OnInit, OnDestroy
{
    product = new Product();
    ...
    constructor(
        private productService: OutgoingItemService,
    ...
    addProduct()
    {
        ...
        this.productService.addProduct(data)
            .then(() => {
                ...
                this.location.go('apps/packingCenter/outgoingItem/' + this.product.id);
            });
    }
